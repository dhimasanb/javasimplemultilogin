...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Connection conn = (Connection) simplelogin.Connections.OpenDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet rs = stm.executeQuery("SELECT * FROM login WHERE username='"+ jTextField1.getText() +"' AND password=MD5('" + jPasswordField1.getText() + "')");
            if (rs.next()) {
